 ...
 */
@Autonomous(name = "NewTwoBlueBeaconOp", group = "Autonomous")
@Disabled
public class NewTwoBlueBeaconOp extends XLinearOpMode {
	...
	public void runOpMode() {
        ...
        // Drive over and hit the second beacon.

		movement.driveForward(0.8, 40);

		movement.pointTurnLeft(90);

		movement.driveBackward(0.8, 115);
